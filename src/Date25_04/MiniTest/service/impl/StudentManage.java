...
import Date25_04.MiniTest.IOFIle.IOFileStudent;
...
public class StudentManage implements Manage<Student> {
    ...
    static IOFileStudent ioFileStudent = new IOFileStudent();
    ...
    public StudentManage(ClassroomManage classroomManage, Scanner scanner) {
        ...
        students.add(new Student("Vũ", 19, "Male", 8, classroomManage.getClassrooms().get(0)));
        students.add(new Student("Đức", 23, "Male", 5, classroomManage.getClassrooms().get(0)));
        students.add(new Student("Chữ", 32, "Male", 9, classroomManage.getClassrooms().get(1)));
        try {
            ioFileStudent.readFileStudent(students);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        try {
            ioFileClassroom.readClassroom(classroomManage.getClassrooms());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public Student create() throws IOException {
        ...
        ioFileStudent.writerFileStudent();
        return student;
